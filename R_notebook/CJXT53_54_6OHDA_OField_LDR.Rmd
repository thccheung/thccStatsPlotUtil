---
title: "CJXT53-54 6OHDA OField LDR, DLC output analysis"
author: "THC Cheung"
...
data_combo <- dplyr::bind_rows(data_BL_paired, data_probe_paired, data_BL_unpaired, data_probe_unpaired)
...
for (i in 114:length(my_colnames_non_char)) {
